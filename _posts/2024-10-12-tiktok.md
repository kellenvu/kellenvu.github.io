...
description: Grew to 12k followers from going LIVE.
comments: true
---
...
- To get more comments, include a low-effort call to action in your videos. For example, my call to action is: "When did you get it?" with four clear options for commenters to choose from.
